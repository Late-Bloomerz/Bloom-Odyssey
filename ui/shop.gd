...
func _ready():
  GameSignal.money_gained.connect(func(value): money += value; money_label.text = "Money: " + str(money))
  GameSignal.item_purchased.connect(func(value): money -= value; money_label.text = "Money: " + str(money))
